...
class BoardExcludedMembersApi
{
     ...
     * @param int $excluded_member_id  (required)
     * @throws \Spinen\ConnectWise\Clients\Service\ApiException on non-2xx response
     * @return \Spinen\ConnectWise\Clients\Service\Model\ExcludedMember
     */
     ...
     * @param int $excluded_member_id  (required)
     * @throws \Spinen\ConnectWise\Clients\Service\ApiException on non-2xx response
     * @return array of \Spinen\ConnectWise\Clients\Service\Model\ExcludedMember, HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceBoardsIdExcludedMembersExcludedMemberIdGetWithHttpInfo($id, $excluded_member_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Spinen\ConnectWise\Clients\Service\Model\ExcludedMember',
                '/service/boards/{id}/excludedMembers/{excludedMemberId}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Spinen\ConnectWise\Clients\Service\Model\ExcludedMember', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Spinen\ConnectWise\Clients\Service\Model\ExcludedMember', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Spinen\ConnectWise\Clients\Service\Model\Error', $e->getResponseHeaders());
     ...
     *
     * @param int $id  (required)
     * @param \Spinen\ConnectWise\Clients\Service\Model\ExcludedMember $excluded_member  (required)
     * @throws \Spinen\ConnectWise\Clients\Service\ApiException on non-2xx response
     * @return \Spinen\ConnectWise\Clients\Service\Model\ExcludedMember
     */

...
class Team implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['team_leader'] = isset($data['team_leader']) ? $data['team_leader'] : null;
        $this->container['members'] = isset($data['members']) ? $data['members'] : null;
        $this->container['default_flag'] = isset($data['default_flag']) ? $data['default_flag'] : null;
        $this->container['notify_on_ticket_delete'] = isset($data['notify_on_ticket_delete']) ? $data['notify_on_ticket_delete'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['team_leader'] === null) {
            $invalid_properties[] = "'team_leader' can't be null";
        }
    ...
    {
        if ((strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Team., must be smaller than or equal to 30.');
        }
    ...
    {
        return $this->container['team_leader'];
    }
    ...
    {
        $this->container['team_leader'] = $team_leader;
    ...
    {
        return $this->container['notify_on_ticket_delete'];
    }
    ...
    {
        $this->container['notify_on_ticket_delete'] = $notify_on_ticket_delete;

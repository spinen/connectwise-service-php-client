...
class Location implements ArrayAccess
{
    ...
    const WHERE_ON_SITE = 'OnSite';
    const WHERE_REMOTE = 'Remote';
    const WHERE_IN_HOUSE = 'InHouse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['where'] === null) {
            $invalid_properties[] = "'where' can't be null";
        }
        $allowed_values = ["OnSite", "Remote", "InHouse"];
        if (!in_array($this->container['where'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'where', must be one of #{allowed_values}.";
        }
    ...
    {
        if ((strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Location., must be smaller than or equal to 30.');
        }

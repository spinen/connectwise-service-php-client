...
> \Spinen\ConnectWise\Clients\Service\Model\Count serviceTicketsIdNotesCountGet($id, $conditions)
...
> \Spinen\ConnectWise\Clients\Service\Model\ServiceNote[] serviceTicketsIdNotesGet($id, $conditions, $order_by, $childconditions, $customfieldconditions, $page, $page_size)
...
[**\Spinen\ConnectWise\Clients\Service\Model\ServiceNote[]**](../Model/ServiceNote.md)
...
> \Spinen\ConnectWise\Clients\Service\Model\ServiceNote serviceTicketsIdNotesNoteIdGet($id, $note_id)
...
> \Spinen\ConnectWise\Clients\Service\Model\ServiceNote serviceTicketsIdNotesNoteIdPatch($id, $note_id, $operations)
...
> \Spinen\ConnectWise\Clients\Service\Model\ServiceNote serviceTicketsIdNotesNoteIdPut($id, $note_id, $service_note)
...
$id = 56; // int | 
$note_id = 56; // int | 
$service_note = new \Spinen\ConnectWise\Clients\Service\Model\ServiceNote(); // \Spinen\ConnectWise\Clients\Service\Model\ServiceNote | 
 ...
 **id** | **int**|  |
 **note_id** | **int**|  |
 **service_note** | [**\Spinen\ConnectWise\Clients\Service\Model\ServiceNote**](../Model/\Spinen\ConnectWise\Clients\Service\Model\ServiceNote.md)|  |
...
> \Spinen\ConnectWise\Clients\Service\Model\ServiceNote serviceTicketsIdNotesPost($id, $service_note)

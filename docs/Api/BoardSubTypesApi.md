...
> \Spinen\ConnectWise\Clients\Service\Model\Count serviceBoardsIdSubtypesCountGet($id, $conditions)
...
> \Spinen\ConnectWise\Clients\Service\Model\SubType[] serviceBoardsIdSubtypesGet($id, $conditions, $order_by, $childconditions, $customfieldconditions, $page, $page_size)
...
[**\Spinen\ConnectWise\Clients\Service\Model\SubType[]**](../Model/SubType.md)
...
> \Spinen\ConnectWise\Clients\Service\Model\SubType serviceBoardsIdSubtypesPost($id, $sub_type)
...
$api_instance = new Spinen\ConnectWise\Clients\Service\Api\BoardSubTypesApi();
$id = 56; // int | 
$sub_type = new \Spinen\ConnectWise\Clients\Service\Model\SubType(); // \Spinen\ConnectWise\Clients\Service\Model\SubType | 
...
------------- | ------------- | ------------- | -------------
 **id** | **int**|  |
 **sub_type** | [**\Spinen\ConnectWise\Clients\Service\Model\SubType**](../Model/\Spinen\ConnectWise\Clients\Service\Model\SubType.md)|  |
...
> \Spinen\ConnectWise\Clients\Service\Model\SubType serviceBoardsIdSubtypesSubtypeIdGet($id, $subtype_id)
...
> \Spinen\ConnectWise\Clients\Service\Model\SubType serviceBoardsIdSubtypesSubtypeIdPatch($id, $subtype_id, $operations)
...
> \Spinen\ConnectWise\Clients\Service\Model\SubType serviceBoardsIdSubtypesSubtypeIdPut($id, $subtype_id, $sub_type)
